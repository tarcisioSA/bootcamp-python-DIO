...
def depositar(saldo, valor, extrato, /):
    if valor > 0:
        ...
        print('\n@@@ Operação falhour! valor invalido. @@@')
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print('Falhou! Valor do saque excede o limite.')
    elif excedeu_saque:
        print('Você atingiu o mumero de saques diarios')
    elif valor > 0:
        saldo -= valor
...
def criar_usuario(usuarios):
    ...
    endereco = input('informe o endereco (logadrouro, nro - bairro - cidade/sigla estado): ')
